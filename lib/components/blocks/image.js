...
var ImageBlock = function (_React$Component) {
  ...
  _createClass(ImageBlock, [{
    ...
    value: function render() {
      ...
      var publicid = data.get("publicid");
      ...
      if (src !== null) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'md-block-image-inner-container', style: {textAlign: "center"}, onClick: this.focusBlock },
            _react2.default.createElement('img', { role: 'presentation', src: src, className: className, publicid: publicid })
          ),
          _react2.default.createElement(
            'figcaption',
            null,
